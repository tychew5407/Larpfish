...
PERFT_SRCS = $(SRC_DIR)/perft.c $(SRC_DIR)/bitboard.c $(SRC_DIR)/board.c \
             ...
             $(SRC_DIR)/fen.c $(SRC_DIR)/zobrist.c
...
ATTACK_SRCS = $(SRC_DIR)/generate_attack_tables.c $(SRC_DIR)/attack_tables.c $(SRC_DIR)/bitboard.c
ATTACK_OBJS = $(patsubst $(SRC_DIR)/%.c, $(BUILD_DIR)/%.o, $(ATTACK_SRCS))
